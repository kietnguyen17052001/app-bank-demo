...
public class TransferConfirm {
	...
	static float amount;
	public static void main(String[] args, Account _sender, Account _receiver, float _amount, String _content) {
	...
	private void initialize() {
		...
		JLabel lblRecipientBank = new JLabel(receiver.bank);
		...
		JLabel lblAccountNumber = new JLabel(sender.accountNumber);
		...
		JLabel lblRecipientAccountNumber = new JLabel(receiver.accountNumber);
		...
		txtRecipientName = new JTextField(receiver.accountName);
		...
		if (content == "") {
			textArea.setText(sender.accountName + " transfers money");
		} else {
			textArea.setText(sender.accountName + " transfers money " + content);
		}
		...
		btnConfirm.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					BusinessLayerLogin.getInstance().confirmTransfer(sender, receiver, amount, textArea.getText());
					JOptionPane.showMessageDialog(null, "Transfer successful", null, JOptionPane.INFORMATION_MESSAGE);
					Transfer.main(null, BusinessLayerLogin.getInstance().getAccountByAccountNumber(sender.accountNumber));
					TransferConfirm.setVisible(false);
